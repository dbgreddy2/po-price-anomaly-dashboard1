...
st.markdown(
    """
    <style>
    .stApp {background: #f5f7fa; color: #1f2a33;}
    .block-container {padding-top: 1.4rem; padding-bottom: 2rem;}
    [data-testid="stSidebar"] {background: #eef2f5;}
    ...
    [data-testid="stMetricValue"] {color: #12304a;}
    [data-testid="stMetricDelta"] {color: #12304a;}
    [data-baseweb="tab-list"] {gap: 1.25rem;}
    [data-baseweb="tab"] {color: #34454f;}
    [aria-selected="true"] {color: #147d92 !important;}
...
k5.metric("Potential price leakage", leakage_display)
...
with overview_tab:
    ...
    row1_right.plotly_chart(risk_figure, use_container_width=True)
    ...
    row2_left.plotly_chart(monthly_figure, use_container_width=True)
    ...
    row1_left.plotly_chart(supplier_figure, use_container_width=True)
    ...
    row2_right.plotly_chart(material_figure, use_container_width=True)
